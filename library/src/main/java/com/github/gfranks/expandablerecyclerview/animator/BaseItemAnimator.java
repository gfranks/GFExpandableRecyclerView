...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    protected abstract void preAnimateRemoveImpl(final RecyclerView.ViewHolder holder);
    protected abstract void preAnimateAddImpl(final RecyclerView.ViewHolder holder);
    ...
    private void doAnimateRemove(final RecyclerView.ViewHolder holder) {
        animateRemoveImpl(holder);mRemoveAnimations.add(holder);
    }
